...
import com.example.materialdata.entity.Spestmtm;
import com.example.materialdata.entity.SpestmtmPK;
...
public interface SpestmtmRepository extends JpaRepository<Spestmtm, SpestmtmPK> {
	...
	@Query("SELECT new com.example.materialdata.dto.MaterialDTO(m.matNm, m.unitPrice, m.majUom, s.id.matCd) " +
			"FROM Spestmtm s " +
			"JOIN s.inmatm m " +
